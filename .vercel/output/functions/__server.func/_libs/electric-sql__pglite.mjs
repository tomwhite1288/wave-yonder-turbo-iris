...
async function Yr({ pg: e, debug: r, args: t, wasmModule: n }) {
	let o, a, s, l = !1, u = [], d = 0, c = -1, p = -1, f = "", m = "", _ = (S) => {
		let v = S.shift();
		G$2(r, "initdb: firstArg", v), zr(v === "/pglite/bin/postgres", `trying to execute ${v}`), e.Module.HEAPU8.set(g), G$2(r, "executing pg main with", S);
		let h = e.callMain(S);
		return G$2(r, h), u = [], h;
		...
		stdin: () => null,
		print: (S) => {
			m += S, G$2(r, "initdbout", S);
		},
		printErr: (S) => {
			f += S, G$2(r, "initdberr", S);
		},
		instantiateWasm: (S, v) => {
	...
	return G$2(r, "calling initdb.main with", t), {
...
H$2 = /* @__PURE__ */ new WeakMap(), v$2 = /* @__PURE__ */ new WeakMap(), F$1 = /* @__PURE__ */ new WeakMap(), M = /* @__PURE__ */ new WeakMap(), y$2 = /* @__PURE__ */ new WeakMap(), b$1 = /* @__PURE__ */ new WeakMap(), m$1 = /* @__PURE__ */ new WeakMap(), x$2 = /* @__PURE__ */ new WeakMap(), P$2 = /* @__PURE__ */ new WeakMap(), D$2 = /* @__PURE__ */ new WeakMap(), S$1 = /* @__PURE__ */ new WeakMap(), n = /* @__PURE__ */ new WeakSet(), C = async function() {
	x$3(this, H$2, await navigator.storage.getDirectory()), x$3(this, v$2, await T$2(this, n, j$1).call(this, this.dataDir, { create: !0 })), x$3(this, F$1, await T$2(this, n, j$1).call(this, G$1, {
		from: h$1(this, v$2),
		create: !0
...
var T = class {
	...
	addInt32(t) {
		return T$2(this, S, L$1).call(this, 4), h$1(this, b).setInt32(h$1(this, g$1), t, h$1(this, k)), x$3(this, g$1, h$1(this, g$1) + 4), this;
	}
	addInt16(t) {
		return T$2(this, S, L$1).call(this, 2), h$1(this, b).setInt16(h$1(this, g$1), t, h$1(this, k)), x$3(this, g$1, h$1(this, g$1) + 2), this;
	}
	addCString(t) {
		return t && this.addString(t), T$2(this, S, L$1).call(this, 1), h$1(this, b).setUint8(h$1(this, g$1), 0), U$1(this, g$1)._++, this;
	}
	addString(t = "") {
		let n = P$1(t);
		return T$2(this, S, L$1).call(this, n), h$1(this, ae$1).encodeInto(t, new Uint8Array(h$1(this, b).buffer, h$1(this, g$1))), x$3(this, g$1, h$1(this, g$1) + n), this;
	}
	add(t) {
		return T$2(this, S, L$1).call(this, t.byteLength), new Uint8Array(h$1(this, b).buffer).set(new Uint8Array(t), h$1(this, g$1)), x$3(this, g$1, h$1(this, g$1) + t.byteLength), this;
	}
	flush(t) {
...
b = /* @__PURE__ */ new WeakMap(), g$1 = /* @__PURE__ */ new WeakMap(), k = /* @__PURE__ */ new WeakMap(), ae$1 = /* @__PURE__ */ new WeakMap(), O = /* @__PURE__ */ new WeakMap(), S = /* @__PURE__ */ new WeakSet(), ie$1 = function(t) {
	...
	if (t) {
		h$1(this, b).setUint8(h$1(this, O), t);
		let n = h$1(this, g$1) - (h$1(this, O) + 1);
		h$1(this, b).setInt32(h$1(this, O) + 1, n, h$1(this, k));
	}
...
var pe$1 = class {
	...
	parse(t, n) {
		...
		let s = h$1(this, D$1) + h$1(this, B$1), i = h$1(this, D$1);
		for (; i + Xe$1 <= s;) {
		...
		i === s ? T$2(this, c, ke).call(this) : (x$3(this, B$1, s - i), x$3(this, D$1, i));
	}
};
A = /* @__PURE__ */ new WeakMap(), B$1 = /* @__PURE__ */ new WeakMap(), D$1 = /* @__PURE__ */ new WeakMap(), o$1 = /* @__PURE__ */ new WeakMap(), c = /* @__PURE__ */ new WeakSet(), ke = function() {
	x$3(this, A, new DataView(Ze$1)), x$3(this, B$1, 0), x$3(this, D$1, 0);
}, et$1 = function(t) {
	if (h$1(this, B$1) > 0) {
		let n = h$1(this, B$1) + t.byteLength;
		if (n + h$1(this, D$1) > h$1(this, A).byteLength) {
			let i;
			if (n <= h$1(this, A).byteLength && h$1(this, D$1) >= h$1(this, B$1)) i = h$1(this, A).buffer;
			else {
				let a = h$1(this, A).byteLength * 2;
				for (; n >= a;) a *= 2;
				i = new ArrayBuffer(a);
			}
			new Uint8Array(i).set(new Uint8Array(h$1(this, A).buffer, h$1(this, D$1), h$1(this, B$1))), x$3(this, A, new DataView(i)), x$3(this, D$1, 0);
		}
		new Uint8Array(h$1(this, A).buffer).set(new Uint8Array(t), h$1(this, D$1) + h$1(this, B$1)), x$3(this, B$1, n);
	} else x$3(this, A, new DataView(t)), x$3(this, D$1, 0), x$3(this, B$1, t.byteLength);
...
`));
			...
			try {
				for (var _ = 0, s = t ? HEAP32[t >> 2] : 0, n = t ? HEAP32[t + 4 >> 2] : 0, l = r ? HEAP32[r >> 2] : 0, d = r ? HEAP32[r + 4 >> 2] : 0, p = a ? HEAP32[a >> 2] : 0, m = a ? HEAP32[a + 4 >> 2] : 0, g = 0, u = 0, f = 0, c = 0, w = 0, S = 0, k = (t ? HEAP32[t >> 2] : 0) | (r ? HEAP32[r >> 2] : 0) | (a ? HEAP32[a >> 2] : 0), E = (t ? HEAP32[t + 4 >> 2] : 0) | (r ? HEAP32[r + 4 >> 2] : 0) | (a ? HEAP32[a + 4 >> 2] : 0), y = (X, R, G, q) => X < 32 ? R & q : G & q, M = 0; M < e; M++) {
					var b = 1 << M % 32;
					if (y(M, k, E, b)) {
...
var N = class N extends z$1 {
	...
	async close() {
		...
		try {
			...
			let o = a;
			o.name === "ExitStatus" && o.status === 0 || T$2(this, x, B).call(this, "An error occured while closing the db", a.toString());
		} finally {
		...
		try {
			...
			T$2(this, x, B).call(this, a), a.status !== 0 && T$2(this, x, B).call(this, "Error when exiting", a.toString());
		} finally {
			try {
	...
	execProtocolRawSync(r) {
		let a = this.mod;
		if (x$3(this, W, 0), x$3(this, L, 0), x$3(this, $, r), h$1(this, H) || x$3(this, H, T$2(this, x, et)), h$1(this, z).length !== N.DEFAULT_RECV_BUF_SIZE && x$3(this, z, new Uint8Array(N.DEFAULT_RECV_BUF_SIZE)), r[0] === 88) return /* @__PURE__ */ new Uint8Array(0);
		...
		return x$3(this, $, []), h$1(this, L) ? new Uint8Array(h$1(this, z).subarray(0, h$1(this, L))) : /* @__PURE__ */ new Uint8Array(0);
	}
...
H = /* @__PURE__ */ new WeakMap(), oe = /* @__PURE__ */ new WeakMap(), _e = /* @__PURE__ */ new WeakMap(), se = /* @__PURE__ */ new WeakMap(), ie = /* @__PURE__ */ new WeakMap(), Fe = /* @__PURE__ */ new WeakMap(), Te = /* @__PURE__ */ new WeakMap(), Pe = /* @__PURE__ */ new WeakMap(), Ce = /* @__PURE__ */ new WeakMap(), de = /* @__PURE__ */ new WeakMap(), ue = /* @__PURE__ */ new WeakMap(), Me = /* @__PURE__ */ new WeakMap(), pe = /* @__PURE__ */ new WeakMap(), ne = /* @__PURE__ */ new WeakMap(), ee = /* @__PURE__ */ new WeakMap(), D = /* @__PURE__ */ new WeakMap(), le = /* @__PURE__ */ new WeakMap(), ce = /* @__PURE__ */ new WeakMap(), I = /* @__PURE__ */ new WeakMap(), me = /* @__PURE__ */ new WeakMap(), $ = /* @__PURE__ */ new WeakMap(), W = /* @__PURE__ */ new WeakMap(), z = /* @__PURE__ */ new WeakMap(), L = /* @__PURE__ */ new WeakMap(), he = /* @__PURE__ */ new WeakMap(), xe = /* @__PURE__ */ new WeakMap(), we = /* @__PURE__ */ new WeakMap(), ge = /* @__PURE__ */ new WeakMap(), x = /* @__PURE__ */ new WeakSet(), Xe = function(r) {
	...
	let d = new WebAssembly.Memory({
		...
		preRun: [
			...
			(u) => {
				u.ENV.HOME = "/home/postgres", u.ENV.USER = "postgres", u.ENV.LOGNAME = "postgres", u.ENV.PGDATA = B$2, u.ENV.PGUSER = r.username ?? "postgres", u.ENV.PGDATABASE = r.database ?? "postgres", u.ENV.LANG = u.ENV.LC_COLLATE = u.ENV.LC_CTYPE = "en_US.UTF-8", u.ENV.TZ = "UTC", u.ENV.PGTZ = "UTC", u.ENV.PGCLIENTENCODING = "UTF8", u.ENV.ICU_DATA = jr, u.PGLITE_ENV && Object.assign(u.ENV, u.PGLITE_ENV);
			},
			(u) => {
	...
	if (p.pg_extensions = a, await n, this.mod = await We(p), await this.fs.initialSyncFs(), r.icuDataDir && await T$2(this, x, $e).call(this, r.icuDataDir), !r.noInitDb) {
		if (r.loadDataDir) {
			...
			T$2(this, x, B).call(this, "pglite: loading data from tarball"), await at$2(this.mod.FS, r.loadDataDir, B$2);
		} else if (this.mod.FS.analyzePath("/pglite/data/PG_VERSION").exists) T$2(this, x, B).call(this, "pglite: found DB, resuming");
		else {
			T$2(this, x, B).call(this, "pglite: no db in filesystem, running initdb");
			let u = { ...r };
			...
			f.close(), await at$2(this.mod.FS, w, B$2), await this.syncToFs();
		}
		await Ue(this.mod, (...u) => T$2(this, x, B).call(this, ...u)), T$2(this, x, Qe).call(this, g, r), this.mod._pgl_setPGliteActive(1), T$2(this, x, _t).call(this, {
			pgDataFolder: B$2,
...
shared_preload_libraries=${r.join(",")}`;
	...
	T$2(this, x, B).call(this, `pglite: icuDataDir specified, removing default icu data dir at ${jr}`), p$2.rmdirRecursive(this.mod.FS, jr), T$2(this, x, B).call(this, `pglite: loading icu data from tarball ${r}`), this.mod.FS.mkdirTree(jr), await at$2(this.mod.FS, r, jr);
}, Je = function(r) {
	x$3(this, he, r.addFunction((a) => (T$2(this, x, B).call(this, `Postgres tried to execute ${r.UTF8ToString(a)}, returning 1.`), 1), "pi")), r._pgl_set_system_fn(h$1(this, he)), x$3(this, xe, r.addFunction((a, o) => {
		...
		T$2(this, x, B).call(this, "pclose_fn", a);
	...
	let a = r.slice(), o = h$1(this, L) + a.length;
	if (o > h$1(this, z).length) {
		...
		s.set(h$1(this, z).subarray(0, h$1(this, L))), x$3(this, z, s);
	}
	return h$1(this, z).set(a, h$1(this, L)), x$3(this, L, h$1(this, L) + a.length), T$2(this, x, qe).call(this, a);
}, qe = function(r) {
	...
	x$3(this, W, 0), x$3(this, L, 0), x$3(this, $, r);
	...
	return this.mod._pgl_sendConnData(), this.mod._pgl_pq_flush(), x$3(this, $, []), h$1(this, L) ? h$1(this, z).subarray(0, h$1(this, L)) : /* @__PURE__ */ new Uint8Array(0);
}, N.paths = {
	PG_ROOT: I$2,
	PGDATA: B$2,
	ICU_DATA_PATH: jr,
