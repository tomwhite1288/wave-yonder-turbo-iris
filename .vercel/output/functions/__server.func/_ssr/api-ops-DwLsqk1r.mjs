...
import { A as requireProfile, N as writeAudit, O as newId, b as getSql, j as todayIso, k as num, l as assertAdmin, u as assertManager, w as listEmployees } from "./session.server-DT32kkW4.mjs";
import { t as createServerRpc } from "./createServerRpc-CcvdN_gc.mjs";
import { t as authMiddleware } from "./middleware-B13c303a.mjs";
import { a as hoursFromEntries, c as loadEntries, m as payrollForEmployee, o as hydrateToday, r as efficiencyForEmployee } from "./queries.server-C0KNibQt.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/api-ops-DwLsqk1r.js
...
var importCodes = createServerFn({ method: "POST" }).validator((d) => d).middleware([authMiddleware]).handler(importCodes_createServerFn_handler, async ({ context, data }) => {
	const profile = await mgr(context.userId);
	assertAdmin(profile);
