...
import { S as ArrowRight, d as Radio, m as MapPinned, n as Wallet, o as Timer, s as ShieldCheck, x as BookOpen } from "../_libs/lucide-react.mjs";
import { a as useCurrentUserState, n as SignedIn, r as SignedOut } from "./gates-B_IGPI9u.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-DsXXQhQV.js
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
					...
					children: "Payroll, timecards, and job-site truth — without replacing dispatch."
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "mt-4 max-w-2xl text-base text-muted",
					children: "Field Ledger sits beside the Maichle's Edge service platform. Tickets still live there. This system answers where the technician was, how long they worked, whether invoice codes match the hours, and what payroll should be."
				}),
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: [
						...
						},
						{
							icon: Radio,
							title: "Live board",
							body: "Managers see the fleet. Technicians get a mobile day view. Integration API in between."
						}
					].map((item) => {
