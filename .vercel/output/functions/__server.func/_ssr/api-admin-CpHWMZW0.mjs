...
//#region node_modules/.nitro/vite/services/ssr/assets/api-admin-CpHWMZW0.js
...
var setAccountStatus = createServerFn({ method: "POST" }).validator((d) => d).middleware([authMiddleware]).handler(createSsrRpc("6ae0ad42dc995273e588da79a5d1588f97790137139aeaf56f2a1de5d52b2168"));
//#endregion
export { setAccountStatus as a, saveAdminEmails as i, getAdminEmails as n, setAdminAccessCode as o, getAdminLoginMeta as r, setEmployeeRole as s, claimAdministrator as t };
