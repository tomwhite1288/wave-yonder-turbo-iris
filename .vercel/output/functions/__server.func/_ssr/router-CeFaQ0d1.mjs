...
import { u as __exportAll } from "./ssr.mjs";
import { D as getSql, E as getPglite, L as newId, N as loadSettings, R as num, Y as writeAudit, b as ensureDbReady, k as hoursFromEntries } from "./session.server-BThkfVCN.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/router-CeFaQ0d1.js
...
var styles_default = "/assets/styles-CCk5rFTC.css";
...
var $$splitComponentImporter$19 = () => import("./routes-BMX0SNlA.mjs");
var Route$24 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$19, "component") });
var $$splitComponentImporter$18 = () => import("./route-Cxbv-SL-.mjs");
var Route$23 = createFileRoute("/app")({ component: lazyRouteComponent($$splitComponentImporter$18, "component") });
var $$splitComponentImporter$17 = () => import("./book-DsX53fa1.mjs");
/** Phone copy is one HTML file hosted on the shop site — not a multi-file app. */
var Route$22 = createFileRoute("/book")({
	head: () => ({ meta: [{ title: "Code Book" }, {
		name: "description",
		content: "One-file HVAC and plumbing code lookup for the truck."
	}] }),
	component: lazyRouteComponent($$splitComponentImporter$17, "component")
});
var $$splitComponentImporter$16 = () => import("./login-CwIQea_p.mjs");
var Route$21 = createFileRoute("/login")({ component: lazyRouteComponent($$splitComponentImporter$16, "component") });
var cors = {
...
async function writeSync(key, body, actor) {
...
async function addPushSub(opts) {
...
async function listPushTargets(key, toUser, fromUser) {
...
var Route$20 = createFileRoute("/api/push")({ server: { handlers: {
	...
	POST: async ({ request }) => {
		...
		try {
			...
			if (body.action === "backup" && body.data) return jsonResponse({
				ok: true,
				...await writeSync(key, { data: body.data })
			});
...
var Route$19 = createFileRoute("/api/sync")({ server: { handlers: {
	OPTIONS: async () => optionsResponse(),
	GET: async ({ request }) => {
		const key = syncKeyOf(request);
		if (key.length < 6) return jsonResponse({ error: "Company key required" }, 401);
		...
		hooks: { after: [{
			...
			handler: createAuthMiddleware(async (ctx) => {
				...
				if (returned instanceof Headers) {
					...
					const { setCookie } = await import("./ssr.mjs").then((n) => n.l).then((n) => n.t);
...
var NETLIFY_SITE = "https://field-agent-maichles.netlify.app";
/** Make this request's origin trusted so Better Auth stops returning Invalid origin. */
function trustThisRequest(request) {
	...
	const pieces = new Set((process.env.BETTER_AUTH_TRUSTED_ORIGINS || "").split(",").map((s) => s.trim()).filter(Boolean));
	pieces.add(origin);
...
var $$splitComponentImporter = () => import("./jobs._ticketId-2_ODoV9-.mjs");
...
var AppRouteRoute = Route$23.update({
	id: "/app",
	path: "/app",
	getParentRoute: () => Route$25
});
var BookRoute = Route$22.update({
	id: "/book",
	path: "/book",
	getParentRoute: () => Route$25
});
...
var ApiPushRoute = Route$20.update({
	id: "/api/push",
	path: "/api/push",
	getParentRoute: () => Route$25
});
var ApiSyncRoute = Route$19.update({
	id: "/api/sync",
	path: "/api/sync",
	getParentRoute: () => Route$25
});
...
//#endregion
export { getBaseURL as a, PACKAGE_VERSION as i, Route$1 as n, GENERIC_OAUTH_ERROR_CODES as r, router_exports as t };
